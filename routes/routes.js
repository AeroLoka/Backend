...
routes.post('/api/flights/', restrict, admin, upload.single('imageUrl'), createFlight);
routes.put('/api/flights/:id', restrict, admin, upload.single('imageUrl'), updateFlight);
