...
const validFilters = [
    'harga-termurah', 'harga-termahal', 'durasi-terpendek', 'durasi-terpanjang',
    'keberangkatan-paling-awal', 'keberangkatan-paling-akhir',
    'kedatangan-paling-awal', 'kedatangan-paling-akhir',
];
...
const getFlights = async (req, res) => {
    try {
        ...
        if (criteria && value) {
            ...
            return res.status(400).json({ success: false, message: 'Kriteria atau filter tidak diberikan' });
        }
